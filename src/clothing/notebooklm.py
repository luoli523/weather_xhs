...
VISUAL_STYLES = [
    ...
    },
    {
        ...
        "desc": (
            "– 水彩晕染质感时装插画风格\n"
            "– 色彩边缘带有自然水渍扩散效果，笔触透明轻盈\n"
            "– 暖色调为主（蜜桃橙/鹅黄/浅珊瑚/雾蓝），色块间有自然渐变过渡\n"
            "– 手账元素点缀：纸胶带边框、邮票贴纸、手写字体标注\n"
            "– 服装通过水彩浓淡变化表现面料质感，留有纸张底纹\n"
            "– 整体气质：文艺清新手账日记感，温柔治愈"
        ),
    },
    {
    ...
    },
    {
        ...
        "desc": (
            "– 韩系时尚杂志大片插画风格\n"
            "– 高级感柔光打光，皮肤质感细腻通透，五官精致立体\n"
            "– 配色克制高级：燕麦白/烟灰/焦糖棕/低饱和莫兰迪色系\n"
            "– 人物气质冷淡慵懒，姿态自然不刻意，韩剧氛围感\n"
            "– 服装注重面料垂坠感和廓形表现，简约但剪裁讲究\n"
            "– 整体气质：首尔街拍杂志感，极简高级，less is more"
        ),
    },
    {
        "name": "时装剪纸拼贴风",
        "desc": (
            "– Matisse 风格剪纸拼贴时装插画\n"
            "– 大胆色块平涂，无渐变，形状边缘保留手工剪切的不规则感\n"
            "– 高饱和对比配色（克莱因蓝/朱红/明黄/翠绿），色块叠加产生层次\n"
            "– 人物高度几何化简化，通过色块拼贴表现服装轮廓和搭配关系\n"
            "– 背景为纯色或撞色几何构成，带有拼贴纸张肌理\n"
            "– 整体气质：艺术海报感，大胆前卫，视觉张力强"
        ),
    },
    {
        "name": "ins 扁平插画风",
        "desc": (
            "– 现代扁平矢量时装插画风格\n"
            "– 干净利落的几何化造型，无描边或极细描边，大色块填充\n"
            "– 配色明快活泼（薄荷绿/珊瑚粉/奶油黄/薰衣草紫），和谐不刺眼\n"
            "– 人物五官极简概括，身材比例略微拉长，姿态轻松时尚\n"
            "– 服装用色块区分层次，图案和印花简化为几何符号\n"
            "– 整体气质：社交媒体友好，现代感强，清爽易读"
        ),
    },
    {
        "name": "可爱卡通动漫风",
